...
// ../node_modules/@airplane/lib/internal/http_error.js
var require_http_error = __commonJS({
  "../node_modules/@airplane/lib/internal/http_error.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var HTTPError = class extends Error {
      ...
      static fromJSON(value) {
        ...
        const attempt = typeof obj.attempt === "number" ? obj.attempt : -1;
        return new HTTPError(message, {
          method,
          url,
          statusCode,
...
// ../node_modules/@airplane/lib/internal/set_timeout.js
var require_set_timeout = __commonJS({
  "../node_modules/@airplane/lib/internal/set_timeout.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.setTimeoutWithCancel = void 0;
    var setTimeoutWithCancel = async (until, controller) => {
...
// ../node_modules/@airplane/lib/internal/fetcher.js
var require_fetcher = __commonJS({
  "../node_modules/@airplane/lib/internal/fetcher.js"(exports) {
    "use strict";
    ...
    var http_error_1 = require_http_error();
    var set_timeout_1 = require_set_timeout();
    var Fetcher = class {
      constructor(opts) {
        if (!opts.host) {
      ...
      async get(path, queryParams, opts = {}) {
        return this.request(path, "GET", __spreadProps(__spreadValues({}, opts), {
          queryParams
        }));
      }
      async post(path, body, opts = {}) {
        return this.request(path, "POST", __spreadProps(__spreadValues({}, opts), {
          body
        }));
      }
      async request(path, method, opts = {}) {
        ...
        for (const [key, value] of Object.entries((_a = opts.queryParams) !== null && _a !== void 0 ? _a : {})) {
          if (value) {
            url.searchParams.set(key, value);
          }
        }
        const idempotencyKey = opts.idempotencyKey || ((_b = opts.headers) === null || _b === void 0 ? void 0 : _b["Idempotency-Key"]) || (0, uuid_1.v4)();
        const headers = __spreadProps(__spreadValues({}, opts.headers), {
          "X-Airplane-Client-Kind": this.opts.clientKind,
          "X-Airplane-Client-Version": this.opts.clientVersion,
        ...
        return fetchWithRetries({
          ...
          timeoutMs: (_c = opts.timeoutMs) !== null && _c !== void 0 ? _c : 1e4,
          retryDelay: (_d = this.opts.retryDelay) !== null && _d !== void 0 ? _d : exports.defaultRetryDelay,
          mode: this.opts.mode,
    ...
    var fetchWithRetries = async (req) => {
      var _a, _b, _c;
      let attempt = 1;
      const maxAttempt = 10;
      let retryAfterMs;
      while (true) {
        ...
        const onAbort = () => {
          var _a2;
          controller.abort();
          (_a2 = req.abortSignal) === null || _a2 === void 0 ? void 0 : _a2.removeEventListener("abort", onAbort);
        };
        ...
        try {
          ...
          const canRetry = status === 429 || status >= 500 && status !== 501 || response.headers.get("X-Airplane-Retryable") === "true";
...
// ../node_modules/@airplane/lib/index.js
var require_lib3 = __commonJS({
  "../node_modules/@airplane/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.setTimeoutWithCancel = exports.HTTPError = exports.Fetcher = void 0;
    var fetcher_1 = require_fetcher();
    ...
    Object.defineProperty(exports, "HTTPError", { enumerable: true, get: function() {
      return http_error_1.HTTPError;
    } });
    var set_timeout_1 = require_set_timeout();
    Object.defineProperty(exports, "setTimeoutWithCancel", { enumerable: true, get: function() {
      return set_timeout_1.setTimeoutWithCancel;
    } });
  }
});
...
// ../node_modules/@opentelemetry/api/build/src/common/Attributes.js
var require_Attributes = __commonJS({
  "../node_modules/@opentelemetry/api/build/src/common/Attributes.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
// ../node_modules/@opentelemetry/api/build/src/trace/tracer_options.js
var require_tracer_options = __commonJS({
  "../node_modules/@opentelemetry/api/build/src/trace/tracer_options.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_src = __commonJS({
  "../node_modules/@opentelemetry/api/build/src/index.js"(exports) {
    ...
    __exportStar(require_diag2(), exports);
    ...
    __exportStar(require_tracer_options(), exports);
    var spancontext_utils_1 = require_spancontext_utils();
  ...
  "../node_modules/airplane/internal/api/client.js"(exports) {
    ...
    var Client = class {
      constructor(opts = {}) {
        ...
        this.fetcher = new lib_1.Fetcher({
          host,
          token,
          apiKey,
          teamID,
      ...
      async getPrompt(id, opts = {}) {
        const resp = await this.fetcher.get("/v0/prompts/get", { id }, { abortSignal: opts.abortSignal });
        return resp.prompt;
      }
      async withTracingPOST(path, f) {
        const tracer = api_1.default.trace.getTracer("js-sdk", package_json_1.default.version);
        return await tracer.startActiveSpan(`fetcher.post`, async (span) => {
          ...
          const headers = {};
          api_1.default.propagation.inject(api_1.default.context.active(), headers);
          try {
...
var require_get = __commonJS({
  "../node_modules/airplane/internal/api/get.js"(exports) {
    ...
    var getSession = async (sessionID, opts = {}) => {
      const client = new client_1.Client(opts);
...
var require_builtins = __commonJS({
  "../node_modules/airplane/internal/builtins/builtins.js"(exports) {
    ...
    var convertResourceAliasToID = (alias) => {
      var _a, _b;
...
// ../node_modules/airplane/internal/date.js
var require_date = __commonJS({
  "../node_modules/airplane/internal/date.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.toISOString = void 0;
    var toISOString = (d) => {
      ...
      const timezone = `${sign}${p(Math.floor(Math.abs(tzo) / 60))}:${p(Math.abs(tzo) % 60)}`;
...
// ../node_modules/airplane/internal/file/file_object.js
var require_file_object = __commonJS({
  "../node_modules/airplane/internal/file/file_object.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isAirplaneFileObject = void 0;
    var isAirplaneFileObject = (o) => {
      return o != null && typeof o === "object" && "__airplaneType" in o && o["__airplaneType"] === "upload";
    };
    exports.isAirplaneFileObject = isAirplaneFileObject;
  }
});
...
var require_types4 = __commonJS({
  "../node_modules/airplane/internal/api/types.js"(exports) {
    ...
    var isSessionStatusTerminal = (status) => {
      switch (status) {
        case "Succeeded":
        case "Failed":
        case "Cancelled":
...
// ../node_modules/airplane/internal/sleep/standard.js
var require_standard = __commonJS({
  "../node_modules/airplane/internal/sleep/standard.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.standardSleep = void 0;
    var standardSleep = async (ms) => {
      return new Promise((resolve) => setTimeout(resolve, ms));
    };
    exports.standardSleep = standardSleep;
  }
});

// ../node_modules/airplane/internal/sleep/utils.js
var require_utils4 = __commonJS({
  "../node_modules/airplane/internal/sleep/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.calculateEndTimeISOString = void 0;
    var calculateEndTimeISOString = (startTimeMs, durationMs) => {
      return new Date(startTimeMs + durationMs).toISOString();
    };
    exports.calculateEndTimeISOString = calculateEndTimeISOString;
  }
});
  ...
  "../node_modules/airplane/internal/runtime/standard.js"(exports) {
    ...
    exports.runtime = {
      execute: async (slug, paramValues = {}, resources, opts = {}) => {
        const client = new client_1.Client(opts);
        const runID = await client.executeTask(slug, paramValues, resources);
...
var require_dev = __commonJS({
  "../node_modules/airplane/internal/runtime/dev.js"(exports) {
    ...
    var lib_1 = require_lib3();
    var abort_controller_1 = require_dist();
    var standard_1 = require_standard2();
    var client_1 = require_client();
    var poller_1 = require_poller();
    var utils_1 = require_utils4();
    exports.runtime = {
...
var require_runtime = __commonJS({
  "../node_modules/airplane/internal/runtime/index.js"(exports) {
    ...
    var registerRuntime = (kind, runtime) => {
...
// ../node_modules/airplane/internal/file/file.js
var require_file = __commonJS({
  "../node_modules/airplane/internal/file/file.js"(exports) {
    "use strict";
    ...
    var _AirplaneFile_instances;
    var _a;
    var _AirplaneFile_blob;
    var _AirplaneFile_download;
    var _AirplaneFile_extractName;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AirplaneFile = void 0;
    var file_object_1 = require_file_object();
    var runtime_1 = require_runtime();
    var AirplaneFile = class {
      constructor(...args) {
        var _b, _c, _d, _e, _f, _g;
        _AirplaneFile_instances.add(this);
        this.__airplaneType = "upload";
        _AirplaneFile_blob.set(this, void 0);
        if ((0, file_object_1.isAirplaneFileObject)(args[0])) {
          const o = args[0];
          this.id = o.id;
          this.url = o.url;
          this.name = __classPrivateFieldGet(AirplaneFile, _a, "m", _AirplaneFile_extractName).call(AirplaneFile, o.url);
          this.size = 0;
          this.type = "";
          ...
          this.name = (_e = (_d = metadata === null || metadata === void 0 ? void 0 : metadata.name) !== null && _d !== void 0 ? _d : __classPrivateFieldGet(AirplaneFile, _a, "m", _AirplaneFile_extractName).call(AirplaneFile, this.url)) !== null && _e !== void 0 ? _e : "";
    ...
    exports.AirplaneFile = AirplaneFile;
    _a = AirplaneFile, _AirplaneFile_blob = new WeakMap(), _AirplaneFile_instances = new WeakSet(), _AirplaneFile_download = async function _AirplaneFile_download2() {
      if (!__classPrivateFieldGet(this, _AirplaneFile_blob, "f")) {
        __classPrivateFieldSet(this, _AirplaneFile_blob, await (0, runtime_1.getRuntime)().fetchBlob(this.url), "f");
    ...
    }, _AirplaneFile_extractName = function _AirplaneFile_extractName2(url) {
      if (!url) {
        return "";
      }
...
// ../node_modules/airplane/internal/file/index.js
var require_file2 = __commonJS({
  "../node_modules/airplane/internal/file/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AirplaneFile = void 0;
    var file_1 = require_file();
    Object.defineProperty(exports, "AirplaneFile", { enumerable: true, get: function() {
      return file_1.AirplaneFile;
    } });
  }
});

// ../node_modules/airplane/internal/params/params_serialized.js
var require_params_serialized = __commonJS({
  "../node_modules/airplane/internal/params/params_serialized.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.serializeParams = exports.serializeParamValue = exports.serializeParamValues = void 0;
    var ts_dedent_1 = __importDefault(require_dist3());
    var date_1 = require_date();
    var file_1 = require_file2();
    var serializeParamValues = (paramValues) => {
      const newParamEntries = Object.entries(paramValues !== null && paramValues !== void 0 ? paramValues : {}).map(([key, val]) => {
        return [key, (0, exports.serializeParamValue)(val)];
      });
      return Object.fromEntries(newParamEntries);
    };
    exports.serializeParamValues = serializeParamValues;
    var serializeParamValue = (paramValue) => {
      if (paramValue instanceof file_1.AirplaneFile) {
        return paramValue.id;
      }
      if (paramValue instanceof Date) {
        return (0, date_1.toISOString)(paramValue);
      }
      return paramValue;
    };
    exports.serializeParamValue = serializeParamValue;
    var serializeParamType = (t) => {
      switch (t) {
        case "shorttext":
    ...
    var serializeParams = (params) => {
      ...
      for (const slug in params) {
        const p = params[slug];
        const param = typeof p === "string" ? { type: p, required: true, name: void 0, description: void 0, default: void 0 } : p;
        const [type, component] = serializeParamType(param.type);
        const regex = "regex" in param ? param.regex : void 0;
        ...
        serializedParams.push({
          ...
          type,
          component,
          desc: param.description && (0, ts_dedent_1.default)(param.description),
          default: (0, exports.serializeParamValue)(param.default),
          constraints: {
            optional,
            options: "options" in param && param.options != null ? serializeOptions(param.options, slug, optional) : void 0,
            regex
          }
        });
      }
    ...
    var isOptionObject = (opt) => {
      return typeof opt === "object" && opt != null && "value" in opt;
    };
    var serializeOptions = (options, slug, optional) => {
      ...
      const optionToLabel = (option) => {
        ...
        if (option instanceof Date) {
          return (0, date_1.toISOString)(option);
        }
        return JSON.stringify(option);
      };
      return options.map((option) => ({
        label: optionToLabel(option),
        value: (0, exports.serializeParamValue)(isOptionObject(option) ? option.value : option)
      }));
    };
  }
});
...
var require_execute = __commonJS({
  "../node_modules/airplane/internal/execute.js"(exports) {
    ...
    var params_serialized_1 = require_params_serialized();
    var runtime_1 = require_runtime();
    var execute = async (slug, paramValues = {}, opts = {}) => {
    ...
    var executeWithResourcesBackground = async (slug, paramValues = {}, resources, opts = {}) => {
    ...
    var executeRunbook = async (slug, paramValues = {}, opts = {}) => {
    ...
    var executeRunbookBackground = async (slug, paramValues = {}, opts = {}) => {
...
var require_email = __commonJS({
  "../node_modules/airplane/internal/builtins/email.js"(exports) {
    ...
    var ts_dedent_1 = require_dist3();
    var builtins_1 = require_builtins();
    var execute_1 = require_execute();
    var message = async (emailResource, sender, recipients, opts = {}) => {
      const { subject, message: message2, client } = opts;
      return (0, execute_1.executeWithResources)("airplane:email_message", {
        sender,
        recipients,
        subject: subject !== null && subject !== void 0 ? subject : "",
        message: (0, ts_dedent_1.dedent)(message2 !== null && message2 !== void 0 ? message2 : "")
      }, { email: (0, builtins_1.convertResourceAliasToID)(emailResource) }, client);
    };
    exports.message = message;
  }
});

// ../node_modules/airplane/internal/builtins/graphql.js
var require_graphql = __commonJS({
  "../node_modules/airplane/internal/builtins/graphql.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.request = void 0;
    var builtins_1 = require_builtins();
    var execute_1 = require_execute();
    var request = async (graphqlResource, operation, opts = {}) => {
      const { variables, headers, urlParams, retryFailures, client } = opts;
      return (0, execute_1.executeWithResources)("airplane:graphql_request", {
        operation,
      ...
      }, { api: (0, builtins_1.convertResourceAliasToID)(graphqlResource) }, client);
    };
    exports.request = request;
  }
});
...
var require_mongodb = __commonJS({
  "../node_modules/airplane/internal/builtins/mongodb.js"(exports) {
    ...
    var builtins_1 = require_builtins();
    var execute_1 = require_execute();
    var find = async (mongodbResource, collection, opts = {}) => {
    ...
    exports.find = find;
    var findOne = async (mongodbResource, collection, opts = {}) => {
    ...
    var findOneAndDelete = async (mongodbResource, collection, opts = {}) => {
      const { filter, projection, sort, client } = opts;
    ...
    var findOneAndUpdate = async (mongodbResource, collection, update, opts = {}) => {
      const { filter, projection, sort, client } = opts;
    ...
    var findOneAndReplace = async (mongodbResource, collection, replacement, opts = {}) => {
    ...
    var insertOne = async (mongodbResource, collection, document, opts = {}) => {
      const { client } = opts;
    ...
    var insertMany = async (mongodbResource, collection, documents, opts = {}) => {
      const { client } = opts;
    ...
    var updateOne = async (mongodbResource, collection, update, opts = {}) => {
    ...
    var updateMany = async (mongodbResource, collection, update, opts = {}) => {
      const { filter, upsert, client } = opts;
    ...
    var deleteOne = async (mongodbResource, collection, filter, opts = {}) => {
      const { client } = opts;
    ...
    var deleteMany = async (mongodbResource, collection, filter, opts = {}) => {
      const { client } = opts;
    ...
    var aggregate = async (mongodbResource, collection, pipeline, opts = {}) => {
      const { client } = opts;
    ...
    var countDocuments = async (mongodbResource, collection, filter, opts = {}) => {
      const { client } = opts;
    ...
    var distinct = async (mongodbResource, collection, field, filter, opts = {}) => {
      const { client } = opts;
...
var require_rest = __commonJS({
  "../node_modules/airplane/internal/builtins/rest.js"(exports) {
    ...
    var builtins_1 = require_builtins();
    var execute_1 = require_execute();
    var request = async (restResource, method, path, opts = {}) => {
      var _a, _b, _c;
...
var require_slack = __commonJS({
  "../node_modules/airplane/internal/builtins/slack.js"(exports) {
    ...
    var ts_dedent_1 = require_dist3();
    var execute_1 = require_execute();
    var message = async (channelName, message2, opts = {}) => {
      const { client } = opts;
...
var require_sql = __commonJS({
  "../node_modules/airplane/internal/builtins/sql.js"(exports) {
    ...
    var builtins_1 = require_builtins();
    var execute_1 = require_execute();
    async function query(sqlResource, query2, opts = {}) {
      let { args, transactionMode, client } = opts;
      transactionMode = transactionMode !== null && transactionMode !== void 0 ? transactionMode : "auto";
      return (0, execute_1.executeWithResources)("airplane:sql_query", { query: (0, ts_dedent_1.dedent)(query2), queryArgs: args, transactionMode }, { db: (0, builtins_1.convertResourceAliasToID)(sqlResource) }, client);
    }
    exports.query = query;
  }
});
...
var handlePreserveConsecutiveUppercase;
var init_decamelize = __esm({
  "../node_modules/decamelize/index.js"() {
    handlePreserveConsecutiveUppercase = (decamelized, separator) => {
...
var humanize_string_exports = {};
__export(humanize_string_exports, {
...
var init_humanize_string = __esm({
  "../node_modules/humanize-string/index.js"() {
    init_decamelize();
  }
});

// ../node_modules/airplane/internal/params/params_output.js
var require_params_output = __commonJS({
  "../node_modules/airplane/internal/params/params_output.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.deserializeParamValues = void 0;
    var deserializeParamValues = (params, paramValues) => {
      const output = {};
      if (!params) {
        return output;
      }
      for (const slug in params) {
        ...
        if (paramValue != null && (type === "date" || type === "datetime")) {
          output[slug] = new Date(paramValue);
        } else {
...
var require_config = __commonJS({
  "../node_modules/airplane/internal/config.js"(exports) {
    ...
    var humanize_string_1 = __importDefault((init_humanize_string(), humanize_string_exports));
    var ts_dedent_1 = require_dist3();
    var execute_1 = require_execute();
    var params_output_1 = require_params_output();
    var task = (config, f) => {
    ...
    var view = (config, view2) => {
      view2.__airplane = {
        type: "view",
        config: __spreadProps(__spreadValues({}, config), {
          description: config.description ? (0, ts_dedent_1.dedent)(config.description) : void 0,
    ...
    var normalizeConfig = (config) => {
      const parameters = config.parameters ? Object.fromEntries(Object.entries(config.parameters).map(([slug, param]) => {
        if (typeof param === "string") {
          return [slug, { type: param, name: (0, humanize_string_1.default)(slug) }];
        }
        return [
          slug,
          __spreadProps(__spreadValues({}, param), {
            description: param.description ? (0, ts_dedent_1.dedent)(param.description) : void 0,
...
// ../node_modules/airplane/internal/display/text.js
var require_text = __commonJS({
  "../node_modules/airplane/internal/display/text.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.markdown = exports.text = void 0;
    var ts_dedent_1 = require_dist3();
    var runtime_1 = require_runtime();
    var text = async (content) => {
      await (0, runtime_1.getRuntime)().display({
        kind: "markdown",
...
var require_table = __commonJS({
  "../node_modules/airplane/internal/display/table.js"(exports) {
    ...
    var filterRowsByColumns = (rows, columns) => {
...
var require_display = __commonJS({
  "../node_modules/airplane/internal/display/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.table = exports.markdown = exports.text = exports.json = void 0;
...
var require_options = __commonJS({
  "../node_modules/airplane/internal/prompt/options.js"(exports) {
    ...
    var params_serialized_1 = require_params_serialized();
    var isLabeledOption = (v) => {
      return typeof v === "object" && Object.prototype.hasOwnProperty.call(v, "value");
    };
    var optionsToSchema = (name, type, opts) => {
      var _a, _b;
      const options = (_a = opts.options) === null || _a === void 0 ? void 0 : _a.map((opt) => {
        if (isLabeledOption(opt)) {
          return __spreadProps(__spreadValues({}, opt), { value: (0, params_serialized_1.serializeParamValue)(opt.value) });
        }
        return (0, params_serialized_1.serializeParamValue)(opt);
      });
      const types = {
        boolean: "boolean",
        upload: "upload",
      ...
      return {
        ...
        default: (0, params_serialized_1.serializeParamValue)(opts.default)
      };
    };
  ...
  "../node_modules/airplane/internal/prompt/index.js"(exports) {
    ...
    var confirm = async (opts = {}) => {
      const promptID = await (0, runtime_1.getRuntime)().promptBackground({
        ...
        description: opts.description ? (0, ts_dedent_1.dedent)(opts.description) : void 0
      });
      await (0, runtime_1.getRuntime)().waitForPrompt(promptID);
      return;
    };
    exports.confirm = confirm;
    var text = async (name, opts = {}) => {
    ...
    var select = async (name, options, opts = {}) => {
      var _a;
      ...
      const param = (0, options_1.optionsToSchema)(name, "integer", __spreadProps(__spreadValues({}, opts), {
    ...
    var prompt = async (params, opts = {}) => {
      return await (await (0, exports.background)(params, opts)).wait();
    };
    exports.prompt = prompt;
    var background = async (params, opts = {}) => {
      const promptID = await (0, runtime_1.getRuntime)().promptBackground({
        schema: {
...
var require_dist4 = __commonJS({
  "../node_modules/ms/dist/index.cjs"(exports, module2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var s = 1e3;
    var m = s * 60;
...
// ../node_modules/airplane/internal/sleep/index.js
var require_sleep = __commonJS({
  "../node_modules/airplane/internal/sleep/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var ms_1 = __importDefault(require_dist4());
    var runtime_1 = require_runtime();
    var sleep = async (duration) => {
      ...
      return (0, runtime_1.getRuntime)().sleep(durationMs);
    };
    exports.sleep = sleep;
  }
});
...
var require_airplane = __commonJS({
  "../node_modules/airplane/index.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.workflow = exports.view = exports.task = exports.executeRunbookBackground = exports.executeRunbook = exports.executeBackground = exports.execute = exports.setOutput = exports.appendOutput = exports.AirplaneFile = exports.SessionTerminationError = exports.RunTerminationError = void 0;
    var api = __importStar(require_api());
    var email = __importStar(require_email());
    var graphql = __importStar(require_graphql());
...
// ../list_of_employees.airplane.ts
__export(exports, {
  default: () => list_of_employees_airplane_default
});
...
var table = base("list_of_employees");
var list_of_employees_airplane_default = import_airplane.default.task({
  ...
  base("list_of_employees").select({
    ...
    records.forEach(function(record) {
      import_airplane.default.appendOutput({ employee_id: record.get("employee_id"), emp_first_name: record.get("emp_first_name"), emp_last_name: record.get("emp_last_name") });
    });
  });
});
